...
func LoadConfig(args []string) (*Config, error) {
	...
	var (
		...
		hostFlag       = fs.String("host", getEnvString("BRIDGE_HOST", DefaultHost), "Bridge HTTP listen host")
		...
		apiKeyFlag     = fs.String("api-key", getEnvString("BRIDGE_API_KEY", ""), "Bearer API key required for incoming requests (optional)")
